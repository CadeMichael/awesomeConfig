...
awful.spawn.with_shell('./.screenlayout/just4k.sh')
...
beautiful.init("/home/cade/.config/awesome/themes/dracula/theme.lua")
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"          }, "s", function () awful.spawn.with_shell("sudo zzz") end,
	      {description = "sleep", group = "desktop functions"}),
    -- Launchers
...
awful.rules.rules = {
    ...
    { rule_any = {type = { "normal", "dialog" }
      }, properties = { titlebars_enabled = false } -- changed from true 
    },
