...
-- wallpaper
theme.wallpaper = theme.wd .. "subway.jpg"
-- awesome icon
theme.awesome_icon = theme.wd .. "void.png"

-- fonts
theme.base_font     = "SauceCodePro Nerd Font"
theme.font          = theme.base_font .. " 18"
theme.hotkeys_font  = theme.base_font .. " 18"
theme.taglist_font  = "SauceCodePro Nerd Font 22"
theme.icon_font     = theme.base_font .. " 18"
